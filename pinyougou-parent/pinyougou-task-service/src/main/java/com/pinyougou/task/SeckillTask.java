...
public class SeckillTask {
	...
	public void refreshSeckillGoods() {
		...
		criteria.andStartTimeLessThanOrEqualTo(new Date());//开始日期<=当前日期
		criteria.andEndTimeGreaterThanOrEqualTo(new Date());//截止日期>=当前日期
	...
	public void removeSeckillGoods() {
		//查询缓存中的数据，扫描每条记录，判断时间，如果当前时间超过了截止时间，移除此记录
